...
//		String url = "http://115.29.51.206/Weixin/station/station_list.do?city=city_name";
		...
		if(data_string != "null"){
			...
			for(int i = 0; i < listArray.size(); i++){
				...
				高德地图用gcj坐标系
				 */
				double[] station_loc_baidu = CoordinateTrans.gcj2bd(station_lat_double, station_lng_double);
				...
				single.put("longitude", String.valueOf(station_loc_baidu[1]));
				single.put("latitude", String.valueOf(station_loc_baidu[0]));
